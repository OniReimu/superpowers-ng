...
mkdir -p "$HOME/.config/opencode/superpowers-ng/skills/priority-test"
cat > "$HOME/.config/opencode/superpowers-ng/skills/priority-test/SKILL.md" <<'EOF'
---
name: priority-test
...
if [ -f "$HOME/.config/opencode/superpowers-ng/skills/priority-test/SKILL.md" ]; then
