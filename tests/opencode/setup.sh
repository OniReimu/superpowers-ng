...
mkdir -p "$HOME/.config/opencode/superpowers-ng"
if [ -d "$REPO_ROOT/lib" ]; then
    cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/superpowers-ng/"
fi
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/superpowers-ng/"
cp -r "$REPO_ROOT/hooks" "$HOME/.config/opencode/superpowers-ng/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/superpowers-ng/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/superpowers.js" "$HOME/.config/opencode/superpowers-ng/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/superpowers-ng/.opencode/plugins/superpowers.js" \
...
echo "Plugin installed to: $HOME/.config/opencode/superpowers-ng/.opencode/plugins/superpowers.js"
