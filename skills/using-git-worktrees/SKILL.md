...
2. ~/.config/superpowers-ng/worktrees/<project-name>/ (global location)
...
### For Global Directory (~/.config/superpowers-ng/worktrees)
...
case $LOCATION in
  .worktrees|worktrees)
    ...
    ;;
  ~/.config/superpowers-ng/worktrees/*)
    path="~/.config/superpowers-ng/worktrees/$project/$BRANCH_NAME"
    ;;
esac
